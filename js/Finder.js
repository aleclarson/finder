...
var Finder, Null, Type, assertType, isType, regexFlags, sharedFinder, type;
...
type.definePrototype({
  ...
  pattern: {
    ...
    set: function(newValue) {
      ...
      this._regex = this._createRegex(newValue, flags);
    }
  },
  offset: {
    get: function() {
    ...
    set: function(newValue) {
      ...
      this._regex.lastIndex = newValue;
    }
  }
});
  ...
  ["multiline", "ignoreCase"].forEach(function(flag) {
    return flagProps[flag] = {
      ...
      set: function(newValue) {
        ...
        this._regex = this._createRegex(this.pattern, flags);
      }
    };
  });
...
type.defineMethods({
  ...
  _parseRegexFlags: function(regex, flags) {
    ...
    for (name in regexFlags) {
      flag = regexFlags[name];
      if (regex[name] === true) {
        flags[flag] = true;
...
type.defineStatics({
  find: function(regex, target, group) {
    ...
    sharedFinder.group = group != null ? group : 0;
